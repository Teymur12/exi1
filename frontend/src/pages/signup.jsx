...
const Signup = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    // const imageValue = imageRef.current.value.trim([0]);
    ...
    try {
      const response = await fetch('/api/auth/signup', {
        ...
        body: JSON.stringify({ userName: userNameValue, fullName: fullNameValue, password: passwordValue, email: emailValue}),
      });
